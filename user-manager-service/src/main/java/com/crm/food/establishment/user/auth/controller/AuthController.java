...
import static com.crm.food.establishment.user.validation.ValidationErrorMessages.INVALID_REFRESH_TOKEN_MESSAGE;
...
public class AuthController {
    ...
    public ResponseEntity<String> refresh(
            @RequestParam @Pattern(regexp = REFRESH_TOKEN_REGEXP, message = INVALID_REFRESH_TOKEN_MESSAGE) String refreshToken
    ) {
